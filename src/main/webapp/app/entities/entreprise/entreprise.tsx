...
import { getEntities, reset } from './entreprise.reducer';

export const Entreprise = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.entreprise.totalItems);
  const links = useAppSelector(state => state.entreprise.links);
  const entity = useAppSelector(state => state.entreprise.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={entrepriseList ? entrepriseList.length : 0}
          next={handleLoadMore}
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/entreprise/${entreprise.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
