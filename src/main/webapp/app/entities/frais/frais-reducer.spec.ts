...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './frais.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAIS actions', async () => {
      const expectedActions = [
        {
