...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
        return admin;
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.nom(UPDATED_NOM);
    ...
    void fullUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
