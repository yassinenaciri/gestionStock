...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './projet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJET_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJET actions', async () => {
      const expectedActions = [
        {
