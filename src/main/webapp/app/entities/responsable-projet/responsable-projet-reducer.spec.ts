...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './responsable-projet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSABLEPROJET_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPONSABLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPONSABLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPONSABLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSABLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPONSABLEPROJET actions', async () => {
      const expectedActions = [
        {
