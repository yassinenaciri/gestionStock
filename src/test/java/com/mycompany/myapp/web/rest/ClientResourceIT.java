...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).mail(DEFAULT_MAIL);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).mail(UPDATED_MAIL);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).mail(UPDATED_MAIL);
