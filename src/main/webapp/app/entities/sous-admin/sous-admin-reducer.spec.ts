...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOUSADMIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOUSADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOUSADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOUSADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOUSADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOUSADMIN actions', async () => {
      const expectedActions = [
        {
