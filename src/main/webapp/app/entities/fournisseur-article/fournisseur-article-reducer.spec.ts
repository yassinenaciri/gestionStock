...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fournisseur-article.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOURNISSEURARTICLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOURNISSEURARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOURNISSEURARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOURNISSEURARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOURNISSEURARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOURNISSEURARTICLE actions', async () => {
      const expectedActions = [
        {
