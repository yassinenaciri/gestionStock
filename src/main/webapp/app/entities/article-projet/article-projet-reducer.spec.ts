...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLEPROJET_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTICLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTICLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTICLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLEPROJET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTICLEPROJET actions', async () => {
      const expectedActions = [
        {
