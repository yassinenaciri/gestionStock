  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gestionStockApp.client.home.createOrEditLabel" data-cy="ClientCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Nom" id="client-nom" name="nom" data-cy="nom" type="text" />
              <ValidatedField label="Prenom" id="client-prenom" name="prenom" data-cy="prenom" type="text" />
              <ValidatedField label="Mail" id="client-mail" name="mail" data-cy="mail" type="text" />
